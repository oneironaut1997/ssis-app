<template>
	<v-container fill-height align-baseline class="home-page__container pa-0">
		<div class="width--100">
			<v-row class="pa-6">
				<v-col cols="12" v-for="(item, index) in student_service_announcements" :key="index">
					<v-card
					class="pa-4 br-8"
					>
						<v-row>
				...
				<template v-if="student_service_announcements.length == 0">
...
<script type="text/javascript">
    ...
    mounted() {
    	...
    	this.student_service_announcements = this.getItem('student_service_announcements');
    },
